...
import org.hibernate.search.mapper.javabean.massindexing.MassIndexingEntityFailureContext;
import org.hibernate.search.mapper.javabean.massindexing.MassIndexingFailureContext;
...
class MassIndexingNotifier {
	...
	void notifyEntityIndexingFailure(MassIndexingIndexedTypeGroup<?, ?> typeGroup,
			JavaBeanMassIndexingSessionContext sessionContext, Object entity, Exception exception) {
	...
	private EntityReference extractReferenceOrSuppress(MassIndexingIndexedTypeGroup<?, ?> typeGroup,
			JavaBeanMassIndexingSessionContext sessionContext, Object entity, Throwable throwable) {
		try {
			Object identifier = null;
			return EntityReferenceFactory.safeCreateEntityReference( sessionContext.entityReferenceFactory(),
					typeGroup.commonSuperType().entityName(), identifier, throwable::addSuppressed );
		}
