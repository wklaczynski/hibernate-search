...
/**
 * A JavaBean loading factory as {@link EntityLoadingFactory}.
 */
public interface JavaBeanEntityLoadingFactory extends EntityLoadingFactory<JavaBeanEntityLoadingStrategyContext, SearchEntityLoadingStrategy> {
