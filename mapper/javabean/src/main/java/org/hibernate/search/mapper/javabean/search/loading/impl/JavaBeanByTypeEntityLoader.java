...
class JavaBeanByTypeEntityLoader<T> implements EntityLoader<EntityReference, T> {

	private static final Log log = LoggerFactory.make( Log.class, MethodHandles.lookup() );

	private final Map<String, EntityLoader<EntityReference, T>> delegatesByEntityName;

	JavaBeanByTypeEntityLoader(Map<String, EntityLoader<EntityReference, T>> delegatesByEntityName) {
