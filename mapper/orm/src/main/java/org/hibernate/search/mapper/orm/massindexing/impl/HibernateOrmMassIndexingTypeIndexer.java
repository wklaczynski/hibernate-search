...
class HibernateOrmMassIndexingTypeIndexer<E, I> implements MassIndexingTypeIndexer<E, I> {
	...
	private final MassIndexingTypeGroupLoader typeGroupLoader;
	...
	public HibernateOrmMassIndexingTypeIndexer(
			...
			MassIndexingTypeGroupLoader<E, I> typeGroupLoader,
	...
	@Override
	public HibernateOrmMassIndexingMappingContext mappingContext() {
