...
class MassIndexingTypeLoaderImpl<E, I> implements MassIndexingTypeLoader<E, I> {
	...
	public MassIndexingTypeLoaderImpl(TypeQueryFactory<E, I> queryFactory,
	...
	public String includedEntityNames() {
		return includedTypes.stream().map( MassIndexingIndexedTypeContext::jpaEntityName )
