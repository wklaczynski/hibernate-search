...
public class LuceneQueryCachingConfigurationContext implements QueryCachingConfigurationContext {

	private final Version luceneVersion;
	private QueryCache cache;
	private QueryCachingPolicy policy;

	public LuceneQueryCachingConfigurationContext(Version luceneVersion) {
