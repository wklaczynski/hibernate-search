...
public interface IndexSchemaElement {
	...
	/**
	 * Add an named predicate factory to this index schema element with the given storage type.
	 *
	 * @param relativeNamedPredicateName The relative name of the new named predicate.
	 * @param factory The factory type.
	 * @param <F> The type of accessors for the new named predicate factory.
	 * @return A DSL step where the named predicate can be defined in more details,
	 * @see NamedPredicateFactory
	 */
	<F> IndexSchemaNamedPredicateOptionsStep<?> namedPredicate(
			String relativeNamedPredicateName, F factory);
